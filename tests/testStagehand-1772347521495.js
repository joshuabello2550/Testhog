...
(async () => {
    ...
    await page.goto('http://localhost:5173/');
    // Step 3
    await stagehand.act("click the session-id input field");
    // Step 4
    await stagehand.act("click the PostHog key input field");
    // Step 5
    await stagehand.act("fill the posthog-key input field with '{{VALUE}}'");
    // Step 6
    await page.goto('http://localhost:5173/');
