...
(async () => {
    ...
    // Step 3
    await stagehand.act("click the 'Get started' link");
    // Step 4
    await stagehand.act("click the input field in the generate section");
    // Step 5
    await stagehand.act("fill the input field in the generate form with '{{VALUE}}'");
    // Step 6
