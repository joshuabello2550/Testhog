...
const POSTHOG_KEY = 'phc_Ad2GYkKKOgCNMGArBzKlwpN3pMlnCavm4PtUm5Dzd5k'

export default function usePostHog(): void {
  useEffect(() => {
...
posthog.init('${POSTHOG_KEY}', {
  ...
  person_profiles: 'identified_only'
    ...
    // no teardown: we keep posthog for the session. If desired, remove script on unmount.
